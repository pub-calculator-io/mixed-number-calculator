...
Version: 1.0.0
Author: Mixed Number Calculator / www.calculator.io
...
if (!function_exists('add_shortcode')) return "No direct call for Mixed Number Calculator by www.calculator.io";

function display_calcio_ci_mixed_number_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_mixed_number_calculator', 'display_calcio_ci_mixed_number_calculator' );